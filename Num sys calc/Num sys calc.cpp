...
int main() {
	...
	do {
		...
		cout << "\nSelect an operation:" << endl
			<< "1) Binary to decimal (2 -> 10)." << endl
			<< "2) Binary to hexadecimal (2 -> 16)." << endl
			<< "3) Decimal to binary (10 -> 2)." << endl
			<< "4) Decimal to hexadecimal (10 -> 16)." << endl
			<< "5) Hexadecimal to decimal (16 -> 10)." << endl
			<< "6) Hexadecimal to binary (16 -> 2)." << endl
			<< "7) Minus decimal to binary (10 -> 2)." << endl
			<< "8) Minus Binary to decimal (2 -> 10)." << endl
			<< "9) Fractional part of decimal to binary (10 -> 2)." << endl
			<< "10) Exit.\n> ";
